...
public class TravelerControllerPostMan {
	...
	// 註冊google
	@PostMapping("/add") 
	public String AddTraveler2(
			@RequestBody String json,
			HttpSession httpsession) throws MessagingException, JsonProcessingException, JSONException {
		...
		//登入
		@PostMapping("/login")
		public String checklogin2(@RequestBody String json,
