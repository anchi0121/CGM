...
public class VenderInformationController {
	...
	public ResponseEntity<?> addFeedback(@PathVariable Integer venderId, @RequestBody FeedbackDTO fb,
	...
	// 新增廠商環境照片 簡易寫法
	@PostMapping("/1234")
	public ResponseEntity<String> addPhoto(@RequestParam("files") MultipartFile[] files, HttpSession session)
			throws IOException {
		Integer venderId = (Integer) session.getAttribute("venderlogin");
