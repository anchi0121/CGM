...
public class VenderController {
	...
	//登入
	@PostMapping("/login") 
	public String checklogin(@RequestBody String json,
	...
	//登入
		...
		public String googlelogin(@RequestBody String json,
				 HttpSession httpsession) throws JSONException{
		...
		public String AddVender(
				@RequestBody String json,HttpSession httpsession
	...
	//註冊簡易版
	@PostMapping("/add2")
	public String AddVender2(
			@RequestBody Vender vender,
			@RequestParam String repwd) throws MessagingException, JSONException {
	...
	public String checkpwd(@RequestParam String acctPwd,
							 @RequestParam String emailPwd,
	...
	//修改個人資料（針對帳密修改
	@PutMapping("/editPwd")
	public String  UpdatePwd(@RequestBody String json
