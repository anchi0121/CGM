  ...
  <div class="card-body ">
    ...
    <div class="card-body d-flex justify-content-center">
      <div class="circular-container border border-5">
        <img :src="imagePath"  class="card-img-top " id="photo" alt="預覽圖">
      </div>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-11 position-relative mx-auto">
        <div class="text-center"><label for="formFile" class="form-label "><i class="bi bi-person-circle me-1"></i>個人照</label></div>
...
<div class="row g-3 needs-validation" novalidate>
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="username" :placeholder="username" v-model="vusername" :disabled="isDisabled" >
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="mobile" :placeholder="mobile" v-model="vmobile" :disabled="isDisabled">
    <div class="invalid-feedback">
     必填
    </div>
  </div>
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="ecName" :placeholder="ecName" v-model="vecName" :disabled="isDisabled">
    <div class="invalid-feedback">
     必填
    </div>
  </div>
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="relationship" :placeholder="relationship" v-model="vrelationship" :disabled="isDisabled">
    <div class="invalid-feedback">
     必填
    </div>
  </div>
...
<div class="card-body">
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control"  id="newPwd" v-model="newPwd" placeholder="6-15位中英字" >
    <div class="invalid-feedback">
      必填
    </div>
  </div>
  <div class="col-md-4 position-relative" >
    ...
    <input type="text" class="form-control" id="reNewPwd" v-model="reNewPwd" placeholder="6-15位中英字" >
    <div class="invalid-feedback">
      必填
    </div>
  </div>
