<template>
    ...
    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">基本資料</button>
    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">修改密碼</button>
  </div>
	 </div>
  ...
  <div class="card-body">
    ...
    <div class="card-body d-flex justify-content-center">
      ...
      <div class="card-body">
        ...
        <div class="text-center"><label for="formFile" class="form-label "><i class="bi bi-person-circle me-1"></i>照片</label></div>
        <input class="form-control form-control-sm" type="file" id="formFile"  @change="handleFileUpload">
        <div class="text-center mt-3"><button @click="uploadFile" class="btn btn-outline-secondary ms-2" data-bs-toggle="modal" data-bs-target="#exampleModal2" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">確定上傳照片<i class="bi bi-image-fill ms-1"></i></button></div>
      </div>
      </div>
    </div>
  </div>
...
<!-- Modal -->
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="coname" :placeholder="coname" v-model="vconame" :disabled="isDisabled" oninput="chkConame()">
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="username" :placeholder="username" v-model="vusername" :disabled="isDisabled" oninput="chkUsername()">
  ...
  <div class="col-md-4 position-relative"></div>
    ...
    <input type="text" class="form-control"  id="tel" :placeholder="tel" v-model="vtel" :disabled="isDisabled" oninput="chkTel()" >
    <span id="telErr"></span>
    <div class="invalid-feedback">
     必填
    </div>
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="mobile" :placeholder="mobile" v-model="vmobile" :disabled="isDisabled" oninput="chkMobile()">
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control"  id="uninum" :placeholder="uninum" v-model="vuninum" :disabled="isDisabled" oninput="chkUninum()">
    ...
    <select class="form-select" v-model="address1" id="address1" :disabled="isDisabled" @change="watchEffect()">
  ...
  <div class="col-md-4 position-relative">
   ...
   <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="street" :placeholder="street" v-model="vstreet" :disabled="isDisabled" oninput="chkStreet()">
  ...
  <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="submitReg" :disabled="isDisabled">確認送出修改</button>
</div>
...
<div class="card-body">
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="pwd" v-model="pwd" placeholder="6-15位中英字" >
    <div class="invalid-feedback">
      必填
    </div>
  </div>
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" id="newPwd" v-model="newPwd" placeholder="6-15位中英字" oninput="chkPwd()">
    <span id="pwdErr"></span>
    <div class="invalid-feedback">
      必填
    </div>
  ...
  <div class="col-md-4 position-relative" >
    ...
    <input type="text" class="form-control" id="reNewPwd" v-model="reNewPwd" placeholder="6-15位中英字" oninput="chkPwdChk()">
  ...
  <div class="d-grid gap-2 col-8 mx-auto mt-5">
	<button class="btn btn-outline-primary" @click="submitReg2" data-bs-toggle="modal" data-bs-target="#exampleModal3">確認送出修改</button>
</div>
</div>
</div>
<!-- Modal -->
...
<style scoped>
    .circular-container {
    width: 230px; /* 調整寬度和高度以設置圓形的大小 */
    height: 230px;
    border-radius: 50%; /* 將邊界半徑設置為50%以創建圓形 */
    overflow: hidden; /* 隱藏超出圓形容器的內容 */
}
    #photo{
      width:100%;
      height:100%;
