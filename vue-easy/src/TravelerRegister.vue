<template>
	 ...
	 <div class="card-header"><h1 class="col-md-4 ">註冊專區</h1></div>
	  <div class="card-body">
<div class="row g-3 needs-validation" > 
  ...
  <div class="col-md-6 position-relative">
    ...
    <input required type="text" class="form-control" id="pwd" v-model="pwd" placeholder="6-15位中英字" >
  ...
  <div class="col-md-6 position-relative mb-3" >
    ...
    <input required type="text" class="form-control" id="repwd" v-model="repwd" placeholder="6-15位中英字" >
